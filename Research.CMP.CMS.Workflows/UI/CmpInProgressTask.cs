...
public class CmpInProgressTask: ContentQueryBase, IContentQuery<CmpQueryCategory> {
    private readonly IContentRepository contentRepository;
    private readonly IInUseNotificationRepository inUseNotificationRepository;
    private readonly IContentLoader contentLoader;

    public CmpInProgressTask(IContentQueryHelper queryHelper, IContentRepository contentRepository, IContentLoader contentLoader,
    ...
    public override string Name => "inProgressTask";
    public override string DisplayName => "In Progress";
    ...
    protected override IEnumerable <IContent> GetContent(ContentQueryParameters parameters)
    {
        return contentLoader
            ...
            .Where(i => i is CmpTaskBlock && (i as CmpTaskBlock).Status == StatusSelectionFactory.InProgress);
    }
}